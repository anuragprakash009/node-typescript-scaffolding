...
class CategoryController {
  ...
  async createCategory(req: Request, res: Response): Promise<Response> {
    this.logger.info(
      `createCategory controller request payload: ${JSON.stringify(req.body)}`,
    );
    try {
      ...
      this.logger.error(
        `createCategory controller request payload: ${JSON.stringify(req.body)} ${error.message} ${error.stack}`,
      );
